...
- By default, training streams activations into the SAE without writing a residual cache and keeps the LLM loaded. If you enable `--cache-activations`, they will be stored as float16 after scaling by `1/256`.
